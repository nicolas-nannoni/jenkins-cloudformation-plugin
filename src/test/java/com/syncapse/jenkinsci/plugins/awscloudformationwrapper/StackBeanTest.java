...
public class StackBeanTest {
	...
	public void parameterParsing_1_Param() {
		...
		final String parameters = "key1=value1";
		stackBean = new StackBean("name", "stack_prefix", "description", "aRecipe", parameters, 0, "awsAccessKey", "awsSecretKey", true, null);
	...
	public void parameterParsing_2_Params() {
		...
		final String parameters = "key1=value1, key2=value2"; // make sure spaces don't mess things up.
		stackBean = new StackBean("name", "stack_prefix", "description", "aRecipe", parameters, 0, "awsAccessKey", "awsSecretKey", true, null);
	...
	public void parsingParameters_Expand_Variables() throws Exception {
		...
		final String parameters = "key1=$value1,key2=${value2}, key3=$value3, key4=${value4}";
		stackBean = new StackBean("name", "stack_prefix", "description", "aRecipe", parameters, 0, "awsAccessKey", "awsSecretKey", true, null);
	...
	public void parsingParameters_With_Semicolons_Expand_Variables() throws Exception {
		env.put("value1", "expandedValue1");
		env.put("value2", "expandedValue2");
		final String parameters = "key1=$value1;key2=${value2}; key3=v1,v2,v3,v4; key4=${value4}";
		stackBean = new StackBean("name", "stack_prefix", "description", "aRecipe", parameters, 0, "awsAccessKey", "awsSecretKey", true, null);
